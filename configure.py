...
with open(buildfile, 'w') as f:
    ...
    f.write(textwrap.dedent('''\
        ...
        cxxflags = -std=gnu++1y {dbgflag} {fpie} -Wall -Werror -Wno-error=deprecated-declarations -fvisibility=hidden {visibility_flags} -DSEASTAR_PAGE_BITS={pagebits} -DSEASTAR_HUGE_PAGE_SIZE={huge_page_size} -pthread -I{srcdir}-U_FORTIFY_SOURCE {user_cflags} {warnings} {defines}
