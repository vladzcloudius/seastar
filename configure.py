...
with open(buildfile, 'w') as f:
    ...
    f.write(textwrap.dedent('''\
        ...
        cxxflags = -std=gnu++1y {dbgflag} {fpie} -Wall -Werror -Wno-error=deprecated-declarations -fvisibility=hidden {visibility_flags} -DSEASTAR_PAGE_BITS={pagebits} -DSEASTAR_CACHE_LINE_SIZE={cache_line_size} -pthread -I. -U_FORTIFY_SOURCE {user_cflags} {warnings} {defines}
        ...
        for binary in build_artifacts:
            ...
            if binary.endswith('.pc'):
                ...
                pc = textwrap.dedent('''\
                        ...
                        Cflags: -std=gnu++1y {dbgflag} {fpie} -Wall -Werror -fvisibility=hidden -DSEASTAR_PAGE_BITS={pagebits} -DSEASTAR_CACHE_LINE_SIZE={cache_line_size} -pthread -I{srcdir} -I{srcdir}/fmt -I{srcdir}/{builddir}/gen {user_cflags} {warnings} {defines} {sanitize} {opt}
