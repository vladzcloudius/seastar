...
class smp_message_queue {
    ...
    lf_queue _pending;
    lf_queue _completed;
    struct alignas(seastar::memory::cache_line_size) {
        size_t _sent = 0;
        size_t _compl = 0;
...
private:
    ...
    std::atomic<bool> _sleeping alignas(seastar::memory::cache_line_size);
    pthread_t _thread_id alignas(seastar::memory::cache_line_size) = pthread_self();
