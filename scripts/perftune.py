...
def auto_detect_irq_mask(cpu_mask):
    ...
    * up to 32 CPU threads: use a single CPU core out of allowed
    * more than 32 CPU threads: use a single CPU core for each 32 CPU threads and distribute them evenly among all
      present NUMA nodes.
